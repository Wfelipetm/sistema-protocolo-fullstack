...
export function LocalizarExact() {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Unidade</Label>
            <Select>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Tipo</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Processo</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Ano</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Grau</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Assunto</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Valor</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Data Abertura</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Requerente</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Nome do Setor</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">CNPJ</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">CPF</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Origem</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Súmula do Processo</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1">
            <Label className="text-blue-700 text-sm font-medium">Número Documento</Label>
            <Select>
              <SelectTrigger className="h-9 bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
